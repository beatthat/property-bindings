...
namespace BeatThat.Properties{
    /// <summary>
    /// A TextureProp that stores its value as a member variable
    /// </summary>
    public class TextureProperty : TextureProp
	{
		public Texture m_value; // TODO: this shouldn't be public but good to see in Inspector. Move to editor class.

		[Tooltip("set FALSE if you want a param to hold its value across disable/enable")]
		public bool m_resetValueOnDisable = true;

		override protected Texture GetValue() { return m_value; }

		override protected void EnsureValue(Texture s) 
		{
			m_value = s;
		}

		override protected void _SetValue(Texture s) { m_value = s; }
